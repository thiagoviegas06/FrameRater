...
const Nav = () => {
  ...
  // Submit handler for the nav search bar
      ...
      <div className="nav-container">
        ...
        {authUser && (
          <div className="nav-links">
            ...
            <Link to="/publiclists" className="nav-link">
              Lists
            </Link>
          </div>
        )}
        ...
        >
          {/* SEARCH BAR */}
          <form className="nav-search" onSubmit={handleNavSearchSubmit}>
            <input
              type="text"
          ...
          {authUser ? (
            ...
            // Not logged-in: only person icon
            <PersonDropdown
              authUser={authUser}
              profileOpen={profileOpen}
              setProfileOpen={setProfileOpen}
